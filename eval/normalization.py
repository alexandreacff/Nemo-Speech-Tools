...
class MarkPreprocessing:
    ...
    exp_let = ['a', 'bê', 'cê', 'dê', 'e', 'éfi', 'gê', 'ága', 'i', 'jota', 'ka',
            'éle', 'eme', 'ene', 'o', 'pê', 'quê', 'érre',
            'ésse', 'tê', 'u', 'vê', 'dáblio', 'xis', 'ypslon', 'zê', 'c cedilha']
            ...
            if MarkPreprocessing.contains_num(word):
                ...
                for seg in segs:
                    if seg.isnumeric():
                        ...
                        numero = int(seg)
                        if abs(numero) < 1000000000000000000:
                            seg = num2words(numero, lang='pt_BR')
                        else:
                            # Lidar com números muito grandes de outra maneira ou ignorá-los
                            seg = ''
